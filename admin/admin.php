...
?>
        ...
        <div class="row mt-5">
          <div class="col-lg-12 d-flex justify-content-center headlighter">Approved Tutor</div>
        </div>
                                  ...
                                  <div class="col-lg-3 col-md-6">
                                    <div class="a-box">
                                      ...
                                      <div class="text-container">
                                            ...
                                            <a href="<?php echo url;?>admin/delete_tutor.php?id=<?php echo $id ?>" id="active_btn">Delete</a>
                                      </div>
                                    </div>
                                  </div>
