          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="./add_tution.php">Delete Tution</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="./reg_Admin.php">Add Admin</a>
                </li>
                <li class="nav-item active">
                  <a class="nav-link" href="./reg_Admin.php">Message</a>
                </li>
                <li class="nav-item">
                          ...
                          if ($count>0)
                          {
                              while($rows=mysqli_fetch_assoc($res))
                              {
                                ...
                                <div class="col-lg-5 p-3 mb-3" id="glass">
                                  ...
                                  ></div>
                                  <div class="row m-3">
                                    <div class="col-sm-6 text-start">Message id:</div>
                                    <div class="col-sm-6 text-center"><?php echo $id ?></div>
                                  </div>
                                  <div class="row m-3">
                                    <div class="col-sm-6 text-start">Name:</div>
                                    <div class="col-sm-6 text-center"><?php echo $Name ?></div>
                                  </div>
                                  <div class="row m-3">
                                    <div class="col-sm-6 text-start">Email:</div>
                                    <div class="col-sm-6 text-center"><?php echo $Email ?></div>
                                  </div>
                                  <div class="row m-3">
                                    <div class="col-sm-6 text-start">Phone:</div>
                                    <div class="col-sm-6 text-center"><?php echo $Phone ?></div>
                                  </div>
                                  <div class="row m-3">
                                    <div class="col-sm-6 text-start">Message:</div>
                                    <div class="col-sm-6 text-center"><?php echo $Message ?> </div>
                                  </div>
                                  
                                  <div class="row m-3 justify-content-end">
                                  <a href="<?php echo url;?>admin/delete_tution.php?id=<?php echo $id ?>" id="active_btn">Done</a>
                                  </div>
                                </div>
